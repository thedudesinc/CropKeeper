...
export class GardenDesignerModalComponent implements OnChanges, OnInit {
  @Input()
  isVisible = false;
  ...
  @Output()
  saveEventEmitter: EventEmitter<GardenPlotPartialInput> =
    new EventEmitter<GardenPlotPartialInput>();
  ...
  get plotName() {
    return this.gardenPropertiesForm.get('plotName');
  }
  get zipCode() {
    return this.gardenPropertiesForm.get('zipCode');
  }
  get notes() {
    return this.gardenPropertiesForm.get('notes');
  }
  get fabricJson() {
    return this.gardenPropertiesForm.get('fabricJson');
  }

  constructor(private fabricService: FabricService) {}

  ngOnInit(): void {
    this.fabricService.gardenPlotSaveEmitter
  ...
  ngOnChanges(): void {
    if (this.gardenPlot) {
      this.gardenPropertiesForm.patchValue(this.gardenPlot);
    }
  }
